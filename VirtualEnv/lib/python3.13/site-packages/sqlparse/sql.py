...
class TokenList(Token):
    ...
    def __init__(self, tokens=None):
        ...
        # Avoid materializing the full subtree via str(self).
        # Concatenating direct children's cached `value` is O(len(tokens)),
        # whereas str(self) recursively flattens the subtree causing O(n * depth) overhead.
